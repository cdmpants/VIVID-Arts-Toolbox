...
Usage (run from Blender's Python or plain Python):
    python vivid_arts_toolbox/build_meshopt.py <path_to_meshoptimizer_source>
...
def main():
    ...
    output_dir = Path(__file__).parent / "lib"
